...
**Caratteristiche:**
- Modello NoSQL in tabelle wide-column* (colonne sparse)
...
*La differenza principale tra database SQL e NoSQL è nel modello dei dati(tabelle, wide-column, Documentale, Key-value e Grafi) e nella flessibilità:
